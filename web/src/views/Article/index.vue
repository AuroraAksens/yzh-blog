<template>
    <div>
        ...
        <div class="mt-3 d-fx jc-between">
            ...
            <!-- 主体 -->
            <div>
                <div class="w-100 bou mb-3 py-2 px-3 text-center animated fadeInDown" style="color: rgb(155, 153, 153);cursor: pointer"><b>文摘</b></div>
...
<script>
    export default {
        ...
        methods: {
            async listBody() {
                const res = await this.$http.get('/wenzhai/list')
                this.List = res.data
            },
            async listSwiper() {
